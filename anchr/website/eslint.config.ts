...
import { noCrossLicenseImport } from "@november-sierra/eslint-config/rules/no-cross-license-import.js";
import { noDirectDbInComponents } from "@november-sierra/eslint-config/rules/no-direct-db-in-components.js";
import { noImplicitReturnArrow } from "@november-sierra/eslint-config/rules/no-implicit-return-arrow.js";
import { noInlineFunctionProps } from "@november-sierra/eslint-config/rules/no-inline-function-props.js";
import { noInlineStyle } from "@november-sierra/eslint-config/rules/no-inline-style.js";
import { noJsxWhitespaceLiteral } from "@november-sierra/eslint-config/rules/no-jsx-whitespace-literal.js";
import { noRawStringJsx } from "@november-sierra/eslint-config/rules/no-raw-string-jsx.js";
import { playwrightExactHeading } from "@november-sierra/eslint-config/rules/playwright-exact-heading.js";
import { preferNullishCheck } from "@november-sierra/eslint-config/rules/prefer-nullish-check.js";
import { reactStyleGuide } from "@november-sierra/eslint-config/rules/react-style-guide.js";
import { singleComponentPerFile } from "@november-sierra/eslint-config/rules/single-component-per-file.js";
import { testAaaPattern } from "@november-sierra/eslint-config/rules/test-aaa-pattern.js";
...
const eslintConfig = defineConfig([
  ...
  ]),
  {
    ...
    rules: {
      "anchr/no-cross-license-import": "error",
