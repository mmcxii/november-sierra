...
const HomePage = async () => {
  ...
  return (
    <main className="mx-auto flex min-h-dvh w-full max-w-lg flex-col justify-end px-6 pt-24 pb-16">
      <p className="sf-rise font-sf-display text-sf-text text-5xl leading-none tracking-tight md:text-6xl">
        {t("seventyFive")}
      </p>
      <p className="sf-rise sf-rise-delay-1 text-sf-muted mt-4 max-w-sm text-base">
